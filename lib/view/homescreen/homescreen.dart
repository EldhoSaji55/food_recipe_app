        ...
        SizedBox(
          ...
          child: ListView.separated(
              ...
              itemBuilder: (context, index) => SizedBox(
                    ...
                    rating: DummyDb.trendingNowList[index][0],
                    videolength: DummyDb.trendingNowList[index][1] ?? '',
                    bgurl: DummyDb.trendingNowList[index][2] ?? '',
                    profileurl: DummyDb.trendingNowList[index][3] ?? '',
                    dishdetails: DummyDb.trendingNowList[index][4] ?? '',
                    postedby: DummyDb.trendingNowList[index][5] ?? '',
                  )),
